...
ActiveRecord::Schema[7.0].define(version: 2023_02_12_124848) do
  ...
  create_hypertable "observation_results", time_column: "created_at", chunk_time_interval: "1 minute", compress_segmentby: "ip_address_id", compress_orderby: "created_at ASC", compression_interval: "P7D"
end
